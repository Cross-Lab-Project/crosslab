...
import { ServiceConfigurationName } from '../../data/serviceConfigurations/index.spec.js';
...
> {
  ...
  compareModels(
    ...
    if (firstModel.participants || secondModel.participants) {
      ...
      assert.strictEqual(firstModel.participants.length, secondModel.participants.length);
