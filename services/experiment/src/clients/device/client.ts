...
export class Client {
  ...
  private fetch = async (url: RequestInfo | URL, init: RequestInit) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        throw new Error('Something went wrong while trying to fetch the request');
      }
    }
  ...
  public async listDevices(
    url: string = '/devices',
  ): Promise<schemas.ListDevicesResponse> {
    // match path to url schema
    const m = new RegExp('^(' + escapeRegex(this.BASE_URL) + ')?/?()(devices)?$').exec(
      url,
    );
  ...
  public async createDevice(
    body: schemas.CreateDeviceRequest,
    url: string = '/devices',
    changedUrl?: string,
  ): Promise<schemas.CreateDeviceResponse> {
    // match path to url schema
    const m = new RegExp('^(' + escapeRegex(this.BASE_URL) + ')?/?()(devices)?$').exec(
      url,
    );
    ...
    // make http call
    const response = await this.fetch(url_with_query_params, {
      method: 'post',
  ...
  public async getDevice(
    url: string,
    flatGroup?: boolean,
  ): Promise<schemas.GetDeviceResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)()?$',
    ).exec(url);
    if (!m) throw new Error('Invalid url');
    let valid_url = '/' + m[2] + '';
    if (valid_url.startsWith('//')) valid_url = valid_url.slice(1);
  ...
  public async updateDevice(
    url: string,
    body?: schemas.UpdateDeviceRequest,
    changedUrl?: string,
  ): Promise<schemas.UpdateDeviceResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)()?$',
    ).exec(url);
  ...
  public async instantiateDevice(
    url: string,
    changedUrl?: string,
  ): Promise<schemas.InstantiateDeviceResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)()?$',
    ).exec(url);
  ...
  public async getDeviceAvailability(
    ...
    startTime?: string,
    endTime?: string,
  ): Promise<schemas.GetDeviceAvailabilityResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)(/availability)?$',
    ).exec(url);
    if (!m) throw new Error('Invalid url');
  ...
  public async deleteDeviceAvailabilityRules(
    url: string,
  ): Promise<schemas.DeleteDeviceAvailabilityRulesResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)(/availability)?$',
    ).exec(url);
  ...
  public async addDeviceAvailabilityRules(
    url: string,
    body?: schemas.AddDeviceAvailabilityRulesRequest,
  ): Promise<schemas.AddDeviceAvailabilityRulesResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)(/availability)?$',
    ).exec(url);
  ...
  public async createWebsocketToken(
    url: string,
  ): Promise<schemas.CreateWebsocketTokenResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)(/websocket)?$',
    ).exec(url);
    if (!m) throw new Error('Invalid url');
  ...
  public async sendSignalingMessage(
    url: string,
    body: schemas.SendSignalingMessageRequest,
    peerconnectionUrl: string,
  ): Promise<schemas.SendSignalingMessageResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(devices/[^?]*?)(/signaling)?$',
    ).exec(url);
    if (!m) throw new Error('Invalid url');
  ...
  public async listPeerconnections(
    url: string = '/peerconnections',
  ): Promise<schemas.ListPeerconnectionsResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?()(peerconnections)?$',
    ).exec(url);
    if (!m) throw new Error('Invalid url');
  ...
  public async createPeerconnection(
    body: schemas.CreatePeerconnectionRequest,
    url: string = '/peerconnections',
    closedUrl?: string,
    statusChangedUrl?: string,
  ): Promise<schemas.CreatePeerconnectionResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?()(peerconnections)?$',
    ).exec(url);
  ...
  public async getPeerconnection(
    url: string,
  ): Promise<schemas.GetPeerconnectionResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(peerconnections/[^?]*?)()?$',
    ).exec(url);
  ...
  public async deletePeerconnection(
    url: string,
  ): Promise<schemas.DeletePeerconnectionResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' + escapeRegex(this.BASE_URL) + ')?/?(peerconnections/[^?]*?)()?$',
    ).exec(url);
  ...
  public async patchPeerconnectionDeviceStatus(
    url: string,
    body: schemas.PatchPeerconnectionDeviceStatusRequest,
    deviceUrl: string,
  ): Promise<schemas.PatchPeerconnectionDeviceStatusResponse> {
    // match path to url schema
    const m = new RegExp(
      '^(' +
        escapeRegex(this.BASE_URL) +
