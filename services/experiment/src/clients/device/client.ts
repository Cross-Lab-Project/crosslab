...
export class Client {
    ...
    public async listDevices(
            options?: {
                headers?: [string, string][],}): Promise<Signatures.ListDevicesSuccessResponse["body"]> {
    ...
    public async createDevice(device: Types.Device<"request">,
            options?: {
                headers?: [string, string][],changedUrl?: string,}): Promise<Signatures.CreateDeviceSuccessResponse["body"]> {
            const url = appendToUrl(this.baseUrl, "/devices")
     ...
     */
    public async sendSignalingMessage(url: string,sigMessage: Types.CreatePeerconnectionMessage<"request"> | Types.ClosePeerconnectionMessage<"request"> | Types.SignalingMessage<"request">,peerconnection_url: string,
            options?: {
                headers?: [string, string][],}): Promise<void> {
    ...
    public async listPeerconnections(
            options?: {
                headers?: [string, string][],}): Promise<Signatures.ListPeerconnectionsSuccessResponse["body"]> {
    ...
    public async createPeerconnection(peerconnection: Types.Peerconnection<"request">,
            options?: {
                headers?: [string, string][],closedUrl?: string,statusChangedUrl?: string,}): Promise<Signatures.CreatePeerconnectionSuccessResponse["body"]> {
            const url = appendToUrl(this.baseUrl, "/peerconnections")
