...
export declare function validatePeerconnectionUrl<T extends 'request' | 'response' | 'all'>(
    object: unknown
): PeerconnectionUrl<T>
...
export declare function validatePeerconnectionUrlRequest<T extends 'request' | 'response' | 'all'>(
    object: unknown
): PeerconnectionUrlRequest<T>

export declare function validatePeerconnectionUrlResponse<T extends 'request' | 'response' | 'all'>(
    object: unknown
): PeerconnectionUrlResponse<T>
