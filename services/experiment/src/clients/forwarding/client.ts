...
export class Client {
  ...
  public async listRooms(options?: {
    ...
    if (!RequestValidation.validateListRoomsOutput(response))
      throw new ValidationError(
        ...
        (RequestValidation.validateListRoomsOutput as Types.FunctionWithErrors).errors,
      );
   ...
   *
   * @returns
   * The room was created. A JSON representation of the new room is returned.
   */
  public async createRoom(
    room: Types.Room<'request'>,
    options?: {
      headers?: [string, string][];
    },
    ...
    if (!RequestValidation.validateCreateRoomInput(body))
      throw new ValidationError(
        'Request validation failed!',
    ...
    if (!RequestValidation.validateCreateRoomOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (RequestValidation.validateCreateRoomOutput as Types.FunctionWithErrors).errors,
      );
  ...
  public async getRoom(
    ...
    if (!RequestValidation.validateGetRoomInput(parameters))
      throw new ValidationError(
        'Request validation failed!',
    ...
    if (!RequestValidation.validateGetRoomOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (RequestValidation.validateGetRoomOutput as Types.FunctionWithErrors).errors,
      );
   ...
   *
   * @returns
   * The JSON Representation of the changed room.
   */
  public async updateRoom(
    ...
    if (!RequestValidation.validateUpdateRoomInput(parameters, body))
      throw new ValidationError(
        'Request validation failed!',
    ...
    if (!RequestValidation.validateUpdateRoomOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (RequestValidation.validateUpdateRoomOutput as Types.FunctionWithErrors).errors,
      );
  ...
  public async deleteRoom(
    ...
    if (!RequestValidation.validateDeleteRoomInput(parameters))
      throw new ValidationError(
        'Request validation failed!',
    ...
    if (!RequestValidation.validateDeleteRoomOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (RequestValidation.validateDeleteRoomOutput as Types.FunctionWithErrors).errors,
      );
