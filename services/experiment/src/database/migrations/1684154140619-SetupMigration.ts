...
export class SetupMigration1684154140619 implements MigrationInterface {
    name = 'SetupMigration1684154140619'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Device" ("uuid" varchar PRIMARY KEY NOT NULL, "url" varchar NOT NULL, "role" varchar NOT NULL, "additionalProperties" text, "experimentUuid" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_Device" ("uuid" varchar PRIMARY KEY NOT NULL, "url" varchar NOT NULL, "role" varchar NOT NULL, "additionalProperties" text, "experimentUuid" varchar, CONSTRAINT "FK_8507dafa0a52f17a0bf75102d18" FOREIGN KEY ("experimentUuid") REFERENCES "Experiment" ("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_Device"("uuid", "url", "role", "additionalProperties", "experimentUuid") SELECT "uuid", "url", "role", "additionalProperties", "experimentUuid" FROM "Device"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Device" ("uuid" varchar PRIMARY KEY NOT NULL, "url" varchar NOT NULL, "role" varchar NOT NULL, "additionalProperties" text, "experimentUuid" varchar)`);
        await queryRunner.query(`INSERT INTO "Device"("uuid", "url", "role", "additionalProperties", "experimentUuid") SELECT "uuid", "url", "role", "additionalProperties", "experimentUuid" FROM "temporary_Device"`);
