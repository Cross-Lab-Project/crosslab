...
export class InstancesCodeUrl1693217063983 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_Instance" ("uuid" varchar PRIMARY KEY NOT NULL, "url" varchar NOT NULL, "token" varchar NOT NULL, "codeUrl" varchar)`);
        await queryRunner.query(`INSERT INTO "temporary_Instance"("uuid", "url", "token") SELECT "uuid", "url", "token" FROM "Instance"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "Instance"("uuid", "url", "token") SELECT "uuid", "url", "token" FROM "temporary_Instance"`);
