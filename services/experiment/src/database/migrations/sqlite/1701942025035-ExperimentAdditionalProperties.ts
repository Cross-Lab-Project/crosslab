...
export class ExperimentAdditionalProperties1701942025035 implements MigrationInterface {
    name = 'ExperimentAdditionalProperties1701942025035'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_Experiment" ("uuid" varchar PRIMARY KEY NOT NULL, "status" varchar NOT NULL, "bookingStart" varchar, "bookingEnd" varchar, "bookingID" varchar, "deletedAt" datetime, "additionalAttributes" text NOT NULL)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Experiment" ("uuid" varchar PRIMARY KEY NOT NULL, "status" varchar NOT NULL, "bookingStart" varchar, "bookingEnd" varchar, "bookingID" varchar, "deletedAt" datetime)`);
