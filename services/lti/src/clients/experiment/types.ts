...
> = ARR['length'] extends END
    ...
    : NumericRangeTuple<
      ...
      >;
                ...
                export type ExperimentOverview<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	/**
	...
	[k: string]: unknown
                ...
                export type Participant<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	/**
	...
	[k: string]: unknown
                ...
                export type ServiceConfiguration<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	/**
	 * Type of the service
	 */
	...
	[k: string]: unknown
                ...
                export type ExperimentChangedEventCallback<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	callbackType: string
	[k: string]: unknown
} & {
	...
	[k: string]: unknown
                ...
                export type ExperimentOverviewUpdate<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	status?: "created" | "booked" | "setup" | "running" | "finished" | "created" | "booked" | "running" | "finished"
	[k: string]: unknown
}
	...
	[k: string]: unknown
                ...
                export type ExperimentUpdate<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	status?: "created" | "booked" | "setup" | "running" | "finished" | "created" | "booked" | "running" | "finished"
	[k: string]: unknown
} & {
	...
	[k: string]: unknown
                ...
                export type TemplateOverview<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	/**
	 * URL of the template
	 */
	...
	[k: string]: unknown
                ...
                export type TemplateUpdate<T extends "request"|"response"|"all" = "all"> = T extends "all" 
                    ? {
	/**
	 * Name of the template
	 */
...
export function isExperimentChangedEventCallback<T extends "request"|"response"|"all" = "all">(
    obj: unknown, type: "request" | "response" | "all" | T = "all"
