...
export declare function validateDeviceDeletedEventCallback<T extends 'request' | 'response' | 'all'>(
    object: unknown
): DeviceDeletedEventCallback<T>
...
export declare function validateDeviceDeletedEventCallbackRequest<T extends 'request' | 'response' | 'all'>(
    object: unknown
): DeviceDeletedEventCallbackRequest<T>

export declare function validateDeviceDeletedEventCallbackResponse<T extends 'request' | 'response' | 'all'>(
    object: unknown
): DeviceDeletedEventCallbackResponse<T>
...
export declare function validateLoggingMessageRequest<T extends 'request' | 'response' | 'all'>(
    object: unknown
): LoggingMessageRequest<T>

export declare function validateLoggingMessageResponse<T extends 'request' | 'response' | 'all'>(
    object: unknown
): LoggingMessageResponse<T>
...
export declare function validateDeletedUrlRequest<T extends 'request' | 'response' | 'all'>(
    object: unknown
): DeletedUrlRequest<T>

export declare function validateDeletedUrlResponse<T extends 'request' | 'response' | 'all'>(
    object: unknown
): DeletedUrlResponse<T>
