  ...
  return async (req: Request, res: Response, next: any) => {
    try {
      ...
      if (parameters["Authorization"] !== undefined) {
        if (!type_validation.validateAuthorizationRequest(parameters["Authorization"])) {
      ...
      if (parameters["X-Real-IP"] !== undefined) {
        if (!type_validation.validateXRealIPRequest(parameters["X-Real-IP"])) {
          const errors = (type_validation.validateXRealIPRequest as any).errors;
          throw new ValidationError("Validation Error", errors, 400);
        }
      }
      if (parameters["X-Forwarded-Proto"] !== undefined) {
        if (
          !type_validation.validateXForwardedProtoRequest(parameters["X-Forwarded-Proto"])
        ) {
  ...
  return async (req: Request, res: Response, next: any) => {
    try {
      if (!type_validation.validatePostLoginRequestBodyRequest(req.body)) {
        const errors = (type_validation.validatePostLoginRequestBodyRequest as any)
          .errors;
        throw new ValidationError("Validation Error", errors, 400);
      }
      return await handler(req as any, res, next);
  ...
  return async (req: Request, res: Response, next: any) => {
    try {
      if (!type_validation.validatePostLogoutRequestBodyRequest(req.body)) {
        const errors = (type_validation.validatePostLogoutRequestBodyRequest as any)
          .errors;
        throw new ValidationError("Validation Error", errors, 400);
      }
      return await handler(req as any, res, next);
  ...
  return async (req: Request, res: Response, next: any) => {
    try {
      if (!type_validation.validatePostUsersRequestBodyRequest(req.body)) {
        const errors = (type_validation.validatePostUsersRequestBodyRequest as any)
          .errors;
        throw new ValidationError("Validation Error", errors, 400);
      }
      return await handler(req as any, res, next);
  ...
  return async (req: Request, res: Response, next: any) => {
    try {
      ...
      if (!type_validation.validatePatchUsersByUserIdRequestBodyRequest(req.body)) {
        const errors = (
          type_validation.validatePatchUsersByUserIdRequestBodyRequest as any
        ).errors;
        throw new ValidationError("Validation Error", errors, 400);
      }
      return await handler(req as any, res, next);
    ...
    try {
      if (req.body !== undefined) {
        if (!type_validation.validatePatchIdentityRequestBodyRequest(req.body)) {
          const errors = (type_validation.validatePatchIdentityRequestBodyRequest as any)
            .errors;
          throw new ValidationError("Validation Error", errors, 400);
        }
      }
