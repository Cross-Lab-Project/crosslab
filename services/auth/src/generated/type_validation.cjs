            ...
            validate31.errors = [
              {
                ...
                keyword: 'enum',
                params: {
                  allowedValues: schema16.allOf[1].properties.method.enum,
                },
                message: 'must be equal to one of the allowed values',
...
const schema18 = {
  type: 'object',
  properties: {
    token: { type: 'string', description: 'The token to be invalidated.' },
  },
  'x-standalone': false,
            ...
            validate65.errors = [
              {
                ...
                keyword: 'enum',
                params: {
                  allowedValues: schema50.allOf[1].properties.method.enum,
                },
                message: 'must be equal to one of the allowed values',
            ...
            validate66.errors = [
              {
                ...
                keyword: 'enum',
                params: {
                  allowedValues: schema51.allOf[1].properties.method.enum,
                },
                message: 'must be equal to one of the allowed values',
