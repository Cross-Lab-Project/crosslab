...
export class Setup1694181940864 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_model" ("uuid" varchar PRIMARY KEY NOT NULL, "username" varchar NOT NULL, "type" varchar NOT NULL, "isAdmin" boolean NOT NULL, "password" varchar, "createdOn" datetime NOT NULL DEFAULT (datetime('now')), "lastLogin" datetime)`,
    );
    await queryRunner.query(
