...
export class Setup1694007494176 implements MigrationInterface {
  name = 'Setup1694007494176';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`user_model\` (\`uuid\` uuid NOT NULL, \`username\` varchar(255) NOT NULL, \`type\` varchar(255) NOT NULL, \`password\` varchar(255) NULL, \`createdOn\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`lastLogin\` datetime NULL, UNIQUE INDEX \`IDX_180abb555e21d4825693f11b94\` (\`username\`), PRIMARY KEY (\`uuid\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
