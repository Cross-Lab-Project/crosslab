...
describe('Config', function () {
    ...
    it('should handle a valid ALLOWLIST option correctly', async function () {
        const TEST_ALLOWLIST = 'url:username,url:username'
        process.env.ALLOWLIST = TEST_ALLOWLIST

        const result = initializeAppConfiguration()

        assert(result.ALLOWLIST == TEST_ALLOWLIST)
    })

    it('should handle an empty ALLOWLIST option correctly', async function () {
