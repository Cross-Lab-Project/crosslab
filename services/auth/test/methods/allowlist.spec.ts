...
import { getAllowlistedUser, parseAllowlist, resolveAllowlist, resolveAllowlistEntry } from "../../src/methods/allowlist"
...
export default () => describe("allowlist methods", async function () {
    ...
    describe("getAllowlistedUser", async function () {
        ...
        it("should correctly return the allowlisted user for the given ip address", async function () {
            ...
            findUserStub.returns(Promise.resolve(<UserModel>{
                username: USERNAME,
                roles: [],
                tokens: []
            }))
