...
type TestError = FetchError | ValidationError | InvalidUrlError | UnsuccessfulRequestError | Error
type TestErrorType = typeof FetchError | typeof ValidationError | typeof InvalidUrlError | typeof UnsuccessfulRequestError | typeof Error
...
export default () => describe("api methods", async function () {
