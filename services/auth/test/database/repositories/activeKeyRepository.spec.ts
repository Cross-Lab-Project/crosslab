...
export default () => describe("Active Key Repository Tests", async function () {
    // TBD
    ...
    describe("save", async function () {
        ...
        it("should save a valid key model", async function () {
            ...
            assert(foundKeyModel.private_key === key.private_key)
            assert(foundKeyModel.public_key === key.public_key)
    ...
    describe("findOne", async function () {
        ...
        it("should find a specific existing key model", async function () {
            ...
            assert(keyModel.private_key === keyModels[0].private_key)
            assert(keyModel.public_key === keyModels[0].public_key)
    ...
    describe("delete", async function () {
        ...
        it("should delete an existing key model", async function () {
            ...
            assert(foundKeyModel.private_key === keyModel.private_key)
