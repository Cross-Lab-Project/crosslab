...
export default function (context: Mocha.Context, testData: TestData) {
    ...
    function buildDeviceSuite(
        ...
        return new Mocha.Suite(`device type '${type}'`)
            .addTest(
                new Mocha.Test(
                    `should update a device of type '${type}'`,
                    async function () {
    ...
    suite.addSuite(buildDeviceSuite('cloud instantiable'))
    suite.addSuite(buildDeviceSuite('device'))
    suite.addSuite(buildDeviceSuite('edge instantiable'))
    suite.addSuite(buildDeviceSuite('group'))
