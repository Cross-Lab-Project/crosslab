...
export class Client {
  ...
  public async listInstitutions(options?: {
    ...
    if (!RequestValidation.validateListInstitutionsInput())
      throw new ValidationError(
        ...
        (
          RequestValidation.validateListInstitutionsInput as Types.FunctionWithErrors
        ).errors,
      );
    ...
    if (!RequestValidation.validateListInstitutionsOutput(response))
      throw new ValidationError(
        ...
        (
          RequestValidation.validateListInstitutionsOutput as Types.FunctionWithErrors
        ).errors,
      );
   ...
   *
   * @returns
   * The institution was created. A JSON representation of the new institution is returned.
   */
  public async createInstitution(
    ...
    if (!RequestValidation.validateCreateInstitutionInput(body))
      throw new ValidationError(
        'Request validation failed!',
        (
          RequestValidation.validateCreateInstitutionInput as Types.FunctionWithErrors
        ).errors,
      );
    ...
    if (!RequestValidation.validateCreateInstitutionOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (
          RequestValidation.validateCreateInstitutionOutput as Types.FunctionWithErrors
        ).errors,
      );
   ...
   *
   * @returns
   * The JSON Representation of the institution
   */
  public async getInstitution(
    ...
    if (!RequestValidation.validateGetInstitutionInput(parameters))
      throw new ValidationError(
        'Request validation failed!',
        (
          RequestValidation.validateGetInstitutionInput as Types.FunctionWithErrors
        ).errors,
      );
    ...
    if (!RequestValidation.validateGetInstitutionOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (
          RequestValidation.validateGetInstitutionOutput as Types.FunctionWithErrors
        ).errors,
      );
   ...
   *
   * @returns
   * The JSON Representation of the changed institution
   */
  public async updateInstitution(
    ...
    if (!RequestValidation.validateUpdateInstitutionInput(parameters, body))
      throw new ValidationError(
        'Request validation failed!',
        (
          RequestValidation.validateUpdateInstitutionInput as Types.FunctionWithErrors
        ).errors,
      );
    ...
    if (!RequestValidation.validateUpdateInstitutionOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (
          RequestValidation.validateUpdateInstitutionOutput as Types.FunctionWithErrors
        ).errors,
      );
  ...
  public async deleteInstitution(
    ...
    if (!RequestValidation.validateDeleteInstitutionInput(parameters))
      throw new ValidationError(
        'Request validation failed!',
        (
          RequestValidation.validateDeleteInstitutionInput as Types.FunctionWithErrors
        ).errors,
      );
    ...
    if (!RequestValidation.validateDeleteInstitutionOutput(response))
      throw new ValidationError(
        'Response validation failed!',
        (
          RequestValidation.validateDeleteInstitutionOutput as Types.FunctionWithErrors
        ).errors,
      );
