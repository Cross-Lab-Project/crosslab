...
export class Client {
    ...
    public async listUsers(
            options?: {
                headers?: [string, string][],username?: string,}): Promise<Signatures.ListUsersSuccessResponse["body"]> {
            const url = appendToUrl(this.baseUrl, "/users")
    ...
    public async createUser(user: Types.User<"request">,
            options?: {
                headers?: [string, string][],}): Promise<Signatures.CreateUserSuccessResponse["body"]> {
            const url = appendToUrl(this.baseUrl, "/users")
     ...
     */
    public async deleteUser(url: string,
            options?: {
    ...
    public async getIdentity(
            options?: {
                headers?: [string, string][],}): Promise<Signatures.GetIdentitySuccessResponse["body"]> {
    ...
    public async updateIdentity(userUpdate: Types.UserUpdate<"request">,
        ...
        if (!RequestValidation.validateUpdateIdentityInput(body))
            throw new ValidationError(
                'Request validation failed!', 
                (RequestValidation.validateUpdateIdentityInput as Types.FunctionWithErrors).errors
            )
        ...
        if (!RequestValidation.validateUpdateIdentityOutput(response))
            throw new ValidationError(
                'Response validation failed!', 
                (RequestValidation.validateUpdateIdentityOutput as Types.FunctionWithErrors).errors
            )
	...
	[k: string]: unknown
            ...
            options?: {
                headers?: [string, string][],}): Promise<Signatures.CreateTokenSuccessResponse["body"]> {
