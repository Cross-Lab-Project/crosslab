...
> {
  model: R extends AbstractRepository<infer M, unknown, unknown, Record<string, object>>
    ? M
    : never;
  request: R extends AbstractRepository<object, infer RQ, unknown, Record<string, object>>
    ? RQ
    : never;
  response: R extends AbstractRepository<
    object,
    unknown,
    infer RSP,
...
export type GenericTestData<
  D extends [
    string,
    string,
    AbstractRepository<object, unknown, unknown, Record<string, object>>,
  ][],
> = D extends [
  infer H extends [
    string,
...
export type ModelType<
  R extends AbstractRepository<object, unknown, unknown, Record<string, object>>,
> = R extends AbstractRepository<infer M, unknown, unknown, Record<string, object>>
  ? M
  : never;

export type RequestType<
  R extends AbstractRepository<object, unknown, unknown, Record<string, object>>,
> = R extends AbstractRepository<object, infer RQ, unknown, Record<string, object>>
  ? RQ
  : never;

export type ResponseType<
  R extends AbstractRepository<object, unknown, unknown, Record<string, object>>,
> = R extends AbstractRepository<object, unknown, infer RSP, Record<string, object>>
  ? RSP
  : never;
