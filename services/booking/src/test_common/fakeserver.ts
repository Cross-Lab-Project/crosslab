...
export async function startFakeServer() {
    ...
    app.get('/devices/00000000-0000-0000-0000-000000000010', (req, res) => {
        switch (fakeServerConfig.device_service_status) {
            case 200:
                res.send('{"url": "http://localhost:10801/devices/00000000-0000-0000-0000-000000000010", "name": "Test Group Booking", "description": "Test group containing two local devices. Used in booking-backend/bookng-frontend tests.", "type": "group", "owner": "http://localhost", "devices": [{"url": "http://localhost:10801/devices/10000000-0000-0000-0000-000000000000"}, {"url": "http://localhost:10801/devices/20000000-0000-0000-0000-000000000000"}]}');
                return;
            case 404:
                res.status(404).send();
                return;
        ...
        switch (fakeServerConfig.device_service_status) {
            case 200:
                ...
                if (fakeServerConfig.device_not_available) {
                    res.send('{"url": "http://localhost:10801/devices/10000000-0000-0000-0000-000000000000", "name": "Test Device", "description": "Test device for unit tests", "type": "device", "owner": "http://localhost", "connected": true, "announcedAvailability": []}');
                    return;
                }
    ...
    app.get('/devices/20000000-0000-0000-0000-000000000000', (req, res) => {
        switch (fakeServerConfig.device_service_status) {
            case 200:
                if (fakeServerConfig.device_single_is_group) {
                    res.send('{"url": "http://localhost:10801/devices/20000000-0000-0000-0000-000000000000", "name": "Test Group 3", "description": "Test group two for unit tests", "type": "group", "owner": "http://localhost", "devices": [{"url": "http://localhost:10801/devices/10000000-0000-0000-0000-000000000000"}, {"url": "http://127.0.0.1:10802/devices/a0000000-0000-0000-0000-000000000000"}]}');
                    return;
                }
                if (fakeServerConfig.device_not_available) {
                    res.send('{"url": "http://localhost:10801/devices/20000000-0000-0000-0000-000000000000", "name": "Test Device 2", "description": "Test device for unit tests", "type": "device", "owner": "http://localhost", "connected": true, "announcedAvailability": []}');
                    return;
                }
                res.send('{"url": "http://localhost:10801/devices/20000000-0000-0000-0000-000000000000", "name": "Test Device 2", "description": "Test device for unit tests", "type": "device", "owner": "http://localhost", "connected": true, "announcedAvailability": [{"start":"1999-01-01T00:00:00Z", "end": "1999-12-31T23:59:59Z"},{"start": "2022-06-20T00:00:00Z", "end": "2022-06-27T06:00:00Z"}, {"start": "2022-06-27T07:00:00Z", "end": "2022-07-01T23:59:59Z"}]}');
                return;
            case 404:
                res.status(404).send();
                return;
