...
export function getFakeRequest(options?: FakeRequestOptions): express.Request {
  ...
  request.authorization.check_authorization_or_fail = async function (
    _action: string,
    _id: string,
  ): Promise<void> {
  ...
  request.authorization.relate = async function (
    user: string,
    action: string,
    id: string,
  ): Promise<boolean> {
  ...
  request.authorization.unrelate = async function (
    user: string,
    action: string,
    id: string,
  ): Promise<boolean> {
