...
export const device = new DeviceClient(baseConfig.BASE_URL, {
  serviceUrl: baseConfig.DEVICE_SERVICE_URL,
  fixedHeaders: [['x-request-authentication', 'experiment-service']],
});
export const booking = {
  backend: new BookingBackendClient(baseConfig.BASE_URL, {
    serviceUrl: baseConfig.BOOKING_BACKEND_URL,
    fixedHeaders: [['x-request-authentication', 'experiment-service']],
  }),
  frontend: new BookingFrontendClient(baseConfig.BASE_URL, {
    serviceUrl: baseConfig.BOOKING_FRONTEND_URL,
    fixedHeaders: [['x-request-authentication', 'experiment-service']],
  }),
  schedule: new ScheduleServiceClient(baseConfig.BASE_URL, {
    serviceUrl: baseConfig.SCHEDULE_SERVICE_URL,
    fixedHeaders: [['x-request-authentication', 'experiment-service']],
  }),
};
...
export const middleware: RequestHandler = (req, _res, next) => {
  ...
  const bound_device = new DeviceClient(baseConfig.BASE_URL, {
    serviceUrl: baseConfig.DEVICE_SERVICE_URL,
