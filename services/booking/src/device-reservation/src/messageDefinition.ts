...
export class ReservationAnswer {
    ...
    static fromString(json: string): ReservationAnswer {
        ...
        let r = new ReservationAnswer(ReservationRequest[data.Type as keyof typeof ReservationRequest], data.ReservationID, data.Deleted, data.Successful, data.ErrorMessage);
    ...
    public constructor(Type: ReservationRequest, ReservationID: bigint, Deleted: boolean, Successful: boolean, ErrorMessage: string) {
        this.Type = Type;
