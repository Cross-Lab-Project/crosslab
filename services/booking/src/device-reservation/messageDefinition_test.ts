...
import { ReservationAnswer, ReservationMessage, ReservationRequest } from "./messageDefinition";
...
mocha.describe("messageDefinition.ts", function () {
    ...
    mocha.it("ReservationAnswer.fromString correct", async () => {
        ...
        if (!m.Start.isSame(data.Start)) {
            throw new Error("Mismatch in Start, should be " + m.Start.toISOString() + " , is " + data.Start.toISOString());
        }

        if (!m.End.isSame(data.End)) {
            throw new Error("Mismatch in End, should be " + m.End.toISOString() + " , is " + data.End.toISOString());
        }
        ...
        if (data.Deleted !== m.Deleted) {
            throw new Error("Mismatch in Deleted, should be " + m.Deleted + " , is " + data.Deleted);
        }

        if (data.Successful !== m.Successful) {
            throw new Error("Mismatch in Successfull, should be " + m.Successful + " , is " + data.Successful);
        }

        if (data.ErrorMessage !== m.ErrorMessage) {
            throw new Error("Mismatch in ErrorMessage, should be " + m.ErrorMessage + " , is " + data.ErrorMessage);
        }
    });
    ...
    mocha.it("ReservationAnswer.fromString Type", async () => {
        ...
        try {
            data.push(ReservationAnswer.fromString('{"Type":0,"ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":1,"ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"Get","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":2,"ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"Delete","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
        } catch (err) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            if (!m.Start.isSame(data[i].Start)) {
                throw new Error("Mismatch in Start, should be " + m.Start.toISOString() + " , is " + data[i].Start.toISOString());
            }

            if (!m.End.isSame(data[i].End)) {
                throw new Error("Mismatch in End, should be " + m.End.toISOString() + " , is " + data[i].End.toISOString());
            }
            ...
            if (data[i].Deleted !== m.Deleted) {
                throw new Error("Mismatch in Deleted, should be " + m.Deleted + " , is " + data[i].Deleted);
            }

            if (data[i].Successful !== m.Successful) {
                throw new Error("Mismatch in Successfull, should be " + m.Successful + " , is " + data[i].Successful);
            }

            if (data[i].ErrorMessage !== m.ErrorMessage) {
                throw new Error("Mismatch in ErrorMessage, should be " + m.ErrorMessage + " , is " + data[i].ErrorMessage);
            }
        }
    ...
    mocha.it("ReservationAnswer.fromString Device", async () => {
        ...
        try {
            data.push(ReservationAnswer.fromString('{"Type":0,"ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
        } catch (err) {
            throw new Error("Error:" + err.toString())
        }
    ...
    mocha.it("ReservationAnswer.fromString Start", async () => {
        ...
        try {
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T02:00:00.000+0100","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T00:00:00.000-0100","End":"2022-06-27T02:00:00.000Z"}'));
        } catch (err) {
            throw new Error("Error:" + err.toString())
        }
        ...
        try {
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","End":"2022-06-27T02:00:00.000Z"}'));
        } catch (err) {
            throw new Error("Error:" + err.toString())
        }
    ...
    mocha.it("ReservationAnswer.fromString End", async () => {
        ...
        try {
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00Z"}'));
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T03:00:00.000+0100"}'));
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T01:00:00.000-0100"}'));
        } catch (err) {
            throw new Error("Error:" + err.toString())
        }
        ...
        try {
            data.push(ReservationAnswer.fromString('{"Type":"New","ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","BookingReference":"http://localhost/unitTest","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z"}'));
        } catch (err) {
            throw new Error("Error:" + err.toString())
        }
    ...
    mocha.it("ReservationAnswer.fromString BookingReference", async () => {
        ...
        try {
            data.push(ReservationAnswer.fromString('{"Type":0,"ReservationID":"7","Deleted":false,"Successful":true,"ErrorMessage":"err","Device":"http://localhost/device/superDevice","Start":"2022-06-27T01:00:00.000Z","End":"2022-06-27T02:00:00.000Z"}'));
        } catch (err) {
            throw new Error("Error:" + err.toString())
        }
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            if (data[i].BookingReference !== undefined) {
                throw new Error("BookingReference existing but shouldn't: " + data[i].BookingReference);
            }
