...
mocha.describe('timetable.ts', function () {
  mocha.it('timetableSortInPlace', function (done) {
    let correct: Timeslot[][] = [
      [
        { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:15:00Z' },
        { Start: '2022-02-01T10:45:00Z', End: '2022-02-01T11:45:00Z' },
        { Start: '2022-02-02T10:15:00Z', End: '2022-02-02T11:15:00Z' },
      ],
      [
        { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:15:00Z' },
        { Start: '2022-02-01T10:45:00Z', End: '2022-02-01T11:45:00Z' },
  ...
  mocha.it('timetableNot', function (done) {
    let correct: Timeslot[][] = [
      [
        { Start: '2022-02-01T10:00:00Z', End: '2022-02-01T10:15:00Z' },
        { Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:30:00Z' },
        { Start: '2022-02-01T11:45:00Z', End: '2022-02-01T12:00:00Z' },
      ], // Basic
      [
        { Start: '2022-02-01T10:00:00Z', End: '2022-02-01T10:15:00Z' },
        { Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:30:00Z' },
    ...
    let t: any[] = [
      {
        ...
        t: [
          { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:15:00Z' },
          { Start: '2022-02-01T11:30:00Z', End: '2022-02-01T11:45:00Z' },
        ],
        start: dayjs('2022-02-01T10:00:00Z'),
        end: dayjs('2022-02-01T12:00:00Z'),
      },
      {
        Name: 'Switched',
        t: [
      ...
      {
        Name: 'start after first value',
        t: [
          { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:15:00Z' },
          { Start: '2022-02-01T11:30:00Z', End: '2022-02-01T11:45:00Z' },
        ],
        start: dayjs('2022-02-01T10:30:00Z'),
        end: dayjs('2022-02-01T12:00:00Z'),
      },
      {
        Name: 'end after second value',
        t: [
          { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:15:00Z' },
          { Start: '2022-02-01T11:30:00Z', End: '2022-02-01T11:45:00Z' },
        ],
        start: dayjs('2022-02-01T10:00:00Z'),
        end: dayjs('2022-02-01T11:30:00Z'),
      },
      {
        Name: 'Both combined',
        t: [
      ...
      {
        Name: 'Ignore multiple time slots',
        t: [
          { Start: '2022-01-25T10:15:00Z', End: '2022-01-25T11:15:00Z' },
          { Start: '2022-01-28T10:15:00Z', End: '2022-01-28T11:15:00Z' },
          { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:15:00Z' },
          { Start: '2022-02-01T11:30:00Z', End: '2022-02-01T11:45:00Z' },
          { Start: '2022-02-05T10:15:00Z', End: '2022-02-05T11:15:00Z' },
          { Start: '2022-20-01T10:15:00Z', End: '2022-02-25T11:15:00Z' },
        ],
        start: dayjs('2022-02-01T10:00:00Z'),
        end: dayjs('2022-02-01T12:00:00Z'),
      },
      ...
      },
      {
        Name: 'Remove all',
        t: [
          { Start: '2022-01-01T10:15:00Z', End: '2022-01-01T11:15:00Z' },
          { Start: '2022-03-01T11:30:00Z', End: '2022-03-01T11:45:00Z' },
        ],
        start: dayjs('2022-02-01T10:00:00Z'),
        end: dayjs('2022-02-01T12:00:00Z'),
      },
      {
        Name: 'Exact',
        t: [
          { Start: '2022-02-01T10:00:00Z', End: '2022-02-01T12:00:00Z' },
          { Start: '2022-03-01T11:30:00Z', End: '2022-03-01T11:45:00Z' },
        ],
        start: dayjs('2022-02-01T10:00:00Z'),
        end: dayjs('2022-02-01T12:00:00Z'),
      },
      {
        Name: 'Overlapping',
        t: [
          { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:30:00Z' },
          { Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:45:00Z' },
        ],
        start: dayjs('2022-02-01T10:00:00Z'),
        end: dayjs('2022-02-01T12:00:00Z'),
      },
  ...
  mocha.it('timetableAnd', function (done) {
    let correct: Timeslot[][] = [
      ...
      [
        { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:10:00Z' },
        { Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:25:00Z' },
        { Start: '2022-02-01T11:30:00Z', End: '2022-02-01T11:45:00Z' },
      ], // Three arrays non overlapping
    ...
    let t: any[] = [
      ...
      {
        Name: 'Multiple overlapping time overwrite',
        t: [
          [
            { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:10:00Z' },
            { Start: '2022-02-01T11:05:00Z', End: '2022-02-01T11:30:00Z' },
            { Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:45:00Z' },
          ],
        ],
      },
      {
        Name: 'Multiple overlapping swapped',
        t: [
          [
            { Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:30:00Z' },
            { Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:30:00Z' },
      ...
      {
        Name: 'Three arrays overlapping',
        t: [
          [{ Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:20:00Z' }],
          [{ Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:25:00Z' }],
          [{ Start: '2022-02-01T11:20:00Z', End: '2022-02-01T11:45:00Z' }],
        ],
      },
      {
        Name: 'Three arrays non overlapping',
        t: [
          [{ Start: '2022-02-01T10:15:00Z', End: '2022-02-01T11:10:00Z' }],
          [{ Start: '2022-02-01T11:15:00Z', End: '2022-02-01T11:25:00Z' }],
          [{ Start: '2022-02-01T11:30:00Z', End: '2022-02-01T11:45:00Z' }],
      ...
      {
        Name: 'Different string formats',
        t: [
          [
            {
              Start: '2022-02-01T10:15:00.0000+0200',
              End: '2022-02-01T09:30:00.0000Z',
            },
            {
              Start: '2022-02-01T11:15:00+0200',
              End: '2022-02-01T11:45:00+0200',
            },
          ],
        ],
      },
