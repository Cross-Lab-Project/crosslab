...
mocha.describe('operations.ts', function () {
  ...
  mocha.it('postBookingSchedule (no error case)', async function () {
    let correctFree = [
      { Start: '2022-06-25T00:00:00Z', End: '2022-06-27T00:10:00Z' },
      { Start: '2022-06-27T00:30:00Z', End: '2022-06-27T01:00:00Z' },
      { Start: '2022-06-27T02:00:00Z', End: '2022-06-27T06:00:00Z' },
      { Start: '2022-06-27T07:00:00Z', End: '2022-06-28T23:59:59Z' },
    ];
    let correctBooked = [
      { Start: '2022-06-27T00:10:00Z', End: '2022-06-27T00:30:00Z' },
      { Start: '2022-06-27T01:00:00Z', End: '2022-06-27T02:00:00Z' },
    ...
    for (let i = 0; i < r.body.length; i++) {
      if (i === 0) {
        if (
          r.body[i].Device !==
          'http://localhost:10801/devices/00000000-0000-0000-0000-000000000001'
        ) {
        ...
        if (
          r.body[i].Device !==
          'http://localhost:10801/devices/00000000-0000-0000-0000-000000000002'
        ) {
        ...
        if (!dayjs(r.body[i].Booked[j].Start).isSame(dayjs(correctBooked[j].Start))) {
          throw Error(
            'Device ' +
              ...
              j +
              ' is wrong, should ' +
              correctBooked[j].Start +
              ' is ' +
              r.body[i].Booked[j].Start,
          );
        }
