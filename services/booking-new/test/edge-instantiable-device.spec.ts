...
const device: InstantiableBrowserDevice<'response'> = {
...
describe('Edge Instantiable Device Tests', function () {
  ...
  step('should create a booking with one edge instantiable device', async function () {
