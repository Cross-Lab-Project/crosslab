...
from crosslab.soa_services.programming.programming_service import (
    ProgrammingService__Consumer,
    ProgrammingService__Producer,
)
...
def test_teardown_reference_leaks_producer(tiebreaker):
    ...
    fs = ProgrammingService__Producer("test")
...
def test_teardown_reference_leaks_consumer(tiebreaker):
    ...
    fs = ProgrammingService__Consumer("test")
