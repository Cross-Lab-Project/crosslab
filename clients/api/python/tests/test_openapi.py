...
async def test_postSchedule(aioresponses: aioresponses):
    ...
    request_dict = json.loads(r'{"Experiment":{"Devices":[{"ID":"https://cHaylvBKdWJSNBxjFMsRIFtEoQDGDi.kucakbCJEWoYBT7b+w9mFqQ"}],"Description":"veniam dolore elit incididunt aliquip"},"Time":{"Start":"2013-01-13T20:09:33.0Z","End":"2009-06-16T17:49:28.0Z"},"Combined":true,"onlyOwn":true}')
    request = post_schedule_request_body_write_from_dict(request_dict)

    parameter_list = [{}, ]
    for parameters in parameter_list:
        response_200_dict = json.loads(r'[{"Device":"deserunt","Booked":[{"Start":"1948-05-26T22:52:29.0Z","End":"2011-12-28T21:02:19.0Z"},{"Start":"1985-12-17T06:33:18.0Z","End":"1978-01-17T14:56:18.0Z"}],"Free":[{"Start":"1961-12-21T15:28:59.0Z","End":"2001-11-26T02:29:25.0Z"},{"Start":"2012-02-01T12:43:15.0Z","End":"1966-03-14T18:59:48.0Z"},{"Start":"1982-08-01T01:23:17.0Z","End":"1994-05-05T01:29:08.0Z"},{"Start":"2008-12-25T13:45:42.0Z","End":"1983-12-04T14:03:12.0Z"}]},{"Device":"voluptate sed","Booked":[{"Start":"2013-11-16T02:13:03.0Z","End":"1998-12-05T21:54:52.0Z"},{"Start":"1984-09-10T01:35:34.0Z","End":"1970-10-26T20:43:56.0Z"},{"Start":"1958-04-09T04:21:09.0Z","End":"1960-07-17T01:12:04.0Z"}],"Free":[{"Start":"1982-08-28T01:36:39.0Z","End":"1968-11-29T09:31:18.0Z"}]},{"Device":"irure laboris consequat minim","Booked":[{"Start":"2010-02-24T01:59:20.0Z","End":"1959-09-08T20:59:10.0Z"}],"Free":[{"Start":"2001-04-08T18:53:37.0Z","End":"2005-06-03T04:52:57.0Z"},{"Start":"1979-01-06T01:59:44.0Z","End":"2019-06-09T18:22:14.0Z"},{"Start":"1971-01-17T01:27:21.0Z","End":"1960-05-18T01:32:06.0Z"}]},{"Device":"est et","Booked":[{"Start":"1969-01-25T18:20:09.0Z","End":"2014-09-14T07:02:09.0Z"},{"Start":"1976-11-10T11:09:01.0Z","End":"2013-12-14T15:27:50.0Z"}],"Free":[{"Start":"1963-05-15T09:50:13.0Z","End":"2011-06-20T15:27:35.0Z"},{"Start":"1944-05-28T17:09:05.0Z","End":"1962-03-03T11:16:44.0Z"},{"Start":"1977-04-01T10:46:36.0Z","End":"2011-07-10T12:31:32.0Z"}]}]')
        aioresponses.post(re.compile(re.escape(full_url)+r'(\?.*)?'), status=200, payload=response_200_dict)
        async with APIClient(BASE_URL) as client:
...
async def test_postBooking(aioresponses: aioresponses):
    ...
    request_dict = json.loads(r'{"Experiment":{"Devices":[{"ID":"https://egpZNfFBa.tvnlNGgk0v"},{"ID":"https://buBjeTLpmnTgKUztkGK.pqvsEwkiZmyNgeSImHsnvoQUf.3KIvtTb"}]},"Time":{"Start":"1947-01-14T01:07:44.0Z","End":"1952-10-13T12:41:25.0Z"},"Type":"normal"}')
...
async def test_putBookingLock(aioresponses: aioresponses):
    ...
    for parameters in parameter_list:
        response_200_dict = json.loads(r'{"Booking":{"ID":"http://yoMAnxJpiGEEkJWmzKnSqBtqhCnvIdMSr.cbrqcVvPcrHoB7.QLta4DcDk.jczRQZu-TfKCushfW+nJ6G0o2G1leLXCDu3a42jPisVbqbz","Time":{"Start":"1991-10-06T20:46:25.0Z","End":"2022-11-09T14:45:01.0Z"},"Devices":["https://xqNbClEPdpHKig.dhiiSiYrU3DYITw6tF1lmUdif8O07Y.LfqivCk3JNt7iUd9J,N4eDsNZfLZ70M","https://yTxELhUrJEDpBapgc.ttgsbLDKBsuj096crVKGCv,kj,hrV-RVDFyUhRLpwvGOaInHu1ZSt1drc5","http://urgvYKPgJ.wss5xn,ZSCgIP5RqnKMw5sFSj27mwK6wfLkBSkbnpwsw2hYZFqmdh+80zT-NM"],"Status":"active","You":false,"External":true,"Message":"Lorem ipsum incididunt","Type":"normal"},"Time":{"Start":"1983-04-16T03:54:47.0Z","End":"2022-12-06T08:27:37.0Z"},"Tokens":[{"Token":"ea Duis anim"},{"Device":"https://lujjGqZNTwEvcLV.nyfEzuMfcb,byZ1.XCuvg+T","Token":"consectetur aute nisi"},{"Device":"https://kFwUbbqqJHNFECezWeTvNmjTlr.ymDXzxt7.mNmOJ7P,4rOs","Token":"cillum sunt qui Lorem dolor"}]}')
        aioresponses.put(re.compile(re.escape(full_url)+r'(\?.*)?'), status=200, payload=response_200_dict)
        async with APIClient(BASE_URL) as client:
...
async def test_postDevice(aioresponses: aioresponses):
    ...
    for parameters in parameter_list:
        response_201_dict = json.loads(r'{"instance":{"announcedAvailability":[{"start":"1955-04-05T20:47:16.0Z","end":"1995-07-09T08:23:32.0Z"},{"end":"2006-05-21T11:22:18.0Z","start":"1956-06-28T14:40:53.0Z"},{"end":"2013-11-27T03:28:07.0Z"},{"end":"2015-04-20T14:43:22.0Z","start":"1975-07-13T04:40:56.0Z"}],"url":"http://uqyLriKDNyKa.qeZcaJtVX9mfvD76xUF+W4nYYFiXhN--1QmKZdxJnnq","services":[],"type":"device","connected":true,"name":"in","owner":"http://XtPxmagFFBylFzvNnkgMTYi.yvmlIqZeAORZPbJktCdGBIj2aFx5zB","description":"nostrud Lorem commodo Excepteur","experiment":"http://ziGqQoyUsaiCVXWUsGq.vgYEjjfQYlaoNU0.TNshwmZX97ESZapPxeXRR6oyHetq"},"deviceToken":"irure eu"}')
        aioresponses.post(re.compile(re.escape(full_url)+r'(\?.*)?'), status=201, payload=response_201_dict)
        async with APIClient(BASE_URL) as client:
...
async def test_postDeviceAvailability(aioresponses: aioresponses):
    ...
    request_dict = json.loads(r'[{"start":"1976-10-06T19:17:50.0Z","end":"2021-01-22T07:23:16.0Z","available":true,"repeat":{"until":"1999-06-30T23:09:57.0Z"}},{"end":"1987-01-03T20:32:33.0Z"}]')
    request = post_device_availability_request_body_write_from_dict(request_dict)

    parameter_list = [{}, ]

    for parameters in parameter_list:
        response_200_dict = json.loads(r'[{"end":"1992-10-13T05:38:45.0Z"},{"start":"1978-02-15T15:31:40.0Z","end":"2008-06-13T20:49:01.0Z"},{"end":"1972-02-02T06:41:51.0Z"},{"start":"1972-12-31T23:40:05.0Z","end":"1987-10-13T06:07:17.0Z"},{"end":"1980-02-27T14:51:27.0Z","start":"1991-04-18T04:50:15.0Z"}]')
        aioresponses.post(re.compile(re.escape(full_url)+r'(\?.*)?'), status=200, payload=response_200_dict)
        async with APIClient(BASE_URL) as client:
