...
async def test_instantiate_device(aioresponses: aioresponses):
    ...
    for parameters in parameter_list:
        response_201_dict = json.loads(r'{"instance":{"url":"https://QXgchCqYONXUzAPMGRmTeYIQPH.teqoxG6A,","type":"device","name":"ut","isPublic":false,"services":[{"serviceType":"http://LWUXWfhewFqXJqGDlmidYcvasq.josW.L,kTfiNQJDoVSE8","supportedConnectionTypes":["consequat officia velit exercitation nostrud","aute voluptate qui deserunt","mollit Ut enim esse"],"serviceId":"incididunt ut velit et"},{"serviceDirection":"prosumer","supportedConnectionTypes":["proident enim","ipsum reprehenderit cupidatat","Duis cupidatat ullamco esse","ut et ut eu Duis","elit pariatur minim exercitation eiusmod"],"serviceType":"http://BfjnukmtIBBFrlUlDUsnbwcTmSol.nyukMUGt7M9GMiT3iG","serviceId":"voluptate in laborum in ea"},{"supportedConnectionTypes":["Excepteur magna pariatur in","dolore nisi do magna non","dolore tempor nostrud eu","nulla","proident Excepteur pariatur"],"serviceType":"http://qqg.vusdW6PWL-CFF8uwdFcDBLz6euFibnpqHZn+RNmnuMAcVZflJPTpIFi,s81WtZqhW5gxWqd","serviceDirection":"consumer","serviceId":"proident qui aute"}],"viewer":[{"url":"http://GHAjzypbekzrDqtakeGI.sxchQVZBiOd5dQOlbrlpOYI.Dfcp1PIfJMczYkFmwu-YcZ4b0wx.63C"},{"url":"http://eYyYFkUsQgn.bkGlQ.Dm,-DJGfnu1fKVtYejV0AH"},{"url":"https://AGMaKjhOIWFatgvfVXKfmQGtrEz.alwKQoa-M7f2HgAT5e3efJBVrN1UG0bUvPZ7WrI,H"},{"url":"https://EUpbwpEWwXamfByIuavGgzkBoysO.pqOCNRaNHvIk4Kg0"}],"announcedAvailability":[{"start":"1998-10-18T11:45:08.0Z","end":"1996-03-28T08:20:36.0Z"},{"start":"2011-01-27T10:56:24.0Z","end":"1971-09-02T12:05:36.0Z"},{"start":"1951-04-10T13:52:29.0Z"},{"start":"2011-05-28T11:26:16.0Z"}],"connected":false,"description":"non sunt pariatur","owner":[{"url":"http://YKMmL.sexrVM,ry.4ci"},{"url":"https://CEODkGKqFRRezDrGQcLpVbkzdJfI.nqxiSgo+geqUAs6Dp2YzjWWLcVCSUkURgLtXk4bU"},{"url":"http://xMBCNKqxAOaIIwMHPJjaqBwnhxHBSBv.xndoq+BZhpHcWe3zQK,OW3RX48t1PxY25Buf"}],"experiment":"http://lFGREWMaUIHRB.wpTIe0mfMwBxtCaJiA9R+u1P2"},"deviceToken":"veniam voluptate id in"}')
        aioresponses.post(re.compile(re.escape(full_url)+r'(\?.*)?'), status=201, payload=response_201_dict)
        async with APIClient(BASE_URL) as client:
...
async def test_create_peerconnection(aioresponses: aioresponses):
    ...
    request = json.loads(r'{"url":"http://HWsenjwtldF.oufaxsH0wiaJIG1zcA.rqCDL-dC","type":"webrtc","status":"closed","devices":[{"url":"http://cc.xbaxafSY0HoKDjJT3s3N0-ygToGFAyhL6t9Z5kPfg7rqUCoSY9LyMOvQZV2,"},{"url":"http://VMVSdYkXYwuHINxUTfCxZjHTgAfserC.qjyGSF25bErHyPkPI46tuYe9Fp,Aaa8qEQZziQoYWaSzbwf+","config":{"services":[{"serviceType":"http://bpmhpKkVhSaWRIJiRhCDqyKhxHo.bknr.oa0K6Dig","serviceId":"quis Duis magna non aute","remoteServiceId":"nisi","remoteServiceDescription":{"serviceDirection":"prosumer","serviceType":"http://ZNackmIMZsjUQZsNAeSrRJnaiNkYpy.atst5Z1lOKbm6UQEA.qkVr-qmxB7vdDMujlCKxj+KzEnnkIMYsAt6v5yYXfVMCBj"}},{"serviceType":"http://SOfYGYxZwMrfHTRHaqkOfEvdsZ.aagr1jElhChsdOyHbXg","serviceId":"enim ea tempor Duis irure","remoteServiceId":"cillum incididunt consequat Duis","remoteServiceDescription":{"serviceId":"voluptate cillum eu","serviceType":"http://DpE.ijmPN3heOD,Vtqtnr4ajl-7gDk.InFB3mkTqrPq0qNGciFDdndqGID6dcs2-0eQjpwOi7,hD2mFVBFuDhbelthg","supportedConnectionTypes":["Ut pariatur","officia in ex ullamco","quis elit","consectetur consequat ut laboris tempor","deserunt amet occaecat qui"]}},{"serviceType":"http://qJGkobAv.bywMPT-MPnB1","serviceId":"aute culpa dolor dolor mollit","remoteServiceId":"amet deserunt occaecat minim cupidatat","remoteServiceDescription":{"serviceDirection":"producer","supportedConnectionTypes":["quis mollit consequat nulla","deserunt","deserunt officia cillum"]}},{"serviceType":"https://xkBwTfylPatDbB.qktiso7mu","serviceId":"sint","remoteServiceId":"dolor"},{"serviceType":"http://izutauorNjk.pkE.,WQPTBrGvHJX2mvTCjSVzJQvGQ7VJUPda","serviceId":"in cupidatat","remoteServiceId":"aliquip ex pariatur ut ipsum","remoteServiceDescription":{"serviceType":"https://PZpgSakCijNqyZhwICEfADjlpfbd.mtdRgP+wiwdP","supportedConnectionTypes":["quis adipisicing dolore aliqua","proident adipisicing"],"serviceId":"occaecat eu in","serviceDirection":"consumer"}}]}}],"configuration":{}}')
