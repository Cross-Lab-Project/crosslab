...
async def test_create_peerconnection(aioresponses: aioresponses):
    ...
    request = json.loads(r'{"url":"http://HWsenjwtldF.oufaxsH0wiaJIG1zcA.rqCDL-dC","type":"webrtc","status":"closed","devices":[{"url":"http://cc.xbaxafSY0HoKDjJT3s3N0-ygToGFAyhL6t9Z5kPfg7rqUCoSY9LyMOvQZV2,"},{"url":"http://VMVSdYkXYwuHINxUTfCxZjHTgAfserC.qjyGSF25bErHyPkPI46tuYe9Fp,Aaa8qEQZziQoYWaSzbwf+","config":{"services":[{"serviceType":"http://kVhSaWRIJiRhCDqyKhxHoidu.ycydq+r.lP6Dig0cpjt","serviceId":"exercitation ad","remoteServiceId":"Ut laborum"},{"serviceType":"http://nYmkxDvUqcxEuXhjwCshXCuy.efqnxTc3yST1lOKbpK6KEA.ufnE","serviceId":"irure in eu cillum","remoteServiceId":"eu fugiat"},{"serviceType":"https://HkujbjUxSPnYCkbQJDma.nfE8bigtqHQBoASLJzqB.CiT9jdB683FtBcLV0EKHz4t4x0BShF8-fYE+SlAQZwOoVBgC","serviceId":"deserunt ipsum","remoteServiceId":"aliqua enim proident adipisicing"},{"serviceType":"http://Xco.zubqdqGID6","serviceId":"in consequat","remoteServiceId":"Duis"},{"serviceType":"http://lfIpckaxRLwrZuByQgxA.xznFDSStxolmUU9RkXmUvuVXczq6kJho1uZeYELHpe","serviceId":"labore dolore laborum sunt velit","remoteServiceId":"nostrud pariatur eiusmod"}]}}],"configuration":{}}')
