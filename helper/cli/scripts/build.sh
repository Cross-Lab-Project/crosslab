...
declare -A binaries=(
    ...
    ["linux-armv7l"]="https://nodejs.org/dist/v20.18.0/node-v20.18.0-linux-armv7l.tar.xz"
    ...
    #["windows-x86"]="https://nodejs.org/dist/v20.18.0/node-v20.18.0-win-x86.zip"
)
...
for binary in "${!binaries[@]}"; do
    ...
    if [[ ${binaries[$binary]} == *.tar.xz ]]; then
        ...
        mv "build/node-${binary}" "dist/crosslab-${binary}"
        ...
        mv "build/node-${binary}.exe" "dist/crosslab-${binary}.exe"
    fi
done