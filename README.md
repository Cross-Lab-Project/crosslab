...
|     | build-spec | build | lint | test | lint-code |
| --- | --- | --- | --- | --- | --- |
| helper/development-container |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/development-container/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/development-container/dist/build.log) |  |  |  |
| helper/tsdoc-theme |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/tsdoc-theme/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/tsdoc-theme/dist/build.log) |  |  |  |
| helper/openapi-codegeneration |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/openapi-codegeneration/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/openapi-codegeneration/dist/build.log) |  |  |  |
| helper/crosslab-typescript-addon |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/crosslab-typescript-addon/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/crosslab-typescript-addon/dist/build.log) |  |  |  |
| helper/dummy-device/js |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/js/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/js/dist/build.log) |  |  | [![lint-code](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/js/dist/lint-code.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/js/dist/lint-code.log) |
| helper/dummy-device/python |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/python/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/python/dist/build.log) | [![lint](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/python/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/helper/dummy-device/python/dist/lint.log) |  |  |
| services/common |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/common/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/common/dist/build.log) |  |  |  |
...
| services/device |  [![build-spec](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/device/dist/build-spec.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/device/dist/build-spec.log) | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/device/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/device/dist/build.log) | [![lint](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/device/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/device/dist/lint.log) |  |  |
| services/experiment |  [![build-spec](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/experiment/dist/build-spec.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/experiment/dist/build-spec.log) | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/experiment/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/experiment/dist/build.log) | [![lint](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/experiment/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/experiment/dist/lint.log) |  |  |
...
| services/update |  [![build-spec](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/update/dist/build-spec.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/update/dist/build-spec.log) | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/update/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/update/dist/build.log) | [![lint](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/update/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/update/dist/lint.log) |  |  |
| services/openapi |  [![build-spec](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/openapi/dist/build-spec.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/openapi/dist/build-spec.log) |  | [![lint](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/openapi/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/openapi/dist/lint.log) |  |  |
| services/gateway |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/gateway/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/services/gateway/dist/build.log) |  |  |  |
| clients/api/js |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/js/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/js/dist/build.log) |  |  |  |
| clients/api/python |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/python/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/python/dist/build.log) | [![lint](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/python/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/python/dist/lint.log) | [![test](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/python/dist/test.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/api/python/dist/test.log) |  |
...
| clients/soa/js |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa/js/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa/js/dist/build.log) |  |  |  |
...
| clients/soa_services/electricalConnection/js |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa_services/electricalConnection/js/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa_services/electricalConnection/js/dist/build.log) |  |  |  |
| clients/soa_services/webcam/js |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa_services/webcam/js/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa_services/webcam/js/dist/build.log) |  |  |  |
| clients/soa_services/file/js |   | [![build](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa_services/file/js/dist/build.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/clients/soa_services/file/js/dist/build.log) |  |  |  |
| integration-test |   |  | [![lint](https://ci.goldi-labs.de/crosslab/authentication_service_tests/integration-test/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/integration-test/dist/lint.log) | [![test](https://ci.goldi-labs.de/crosslab/authentication_service_tests/integration-test/dist/test.badge)](https://ci.goldi-labs.de/crosslab/authentication_service_tests/integration-test/dist/test.log) |  |
...
%%{init:{'flowchart':{'nodeSpacing': 20, 'rankSpacing': 80, 'curve': 'linear', 'useMaxWidth': false}}}%%
  ...
  subgraph helper/dummy-device/js
    ...
    helper/dummy-device/js:lint-code[lint-code]
  end
  ...
  clients/api/js:build[build] --> helper/dummy-device/js:lint-code[lint-code]
  clients/soa/js:build[build] --> helper/dummy-device/js:lint-code[lint-code]
  clients/soa_services/electricalConnection/js:build[build] --> helper/dummy-device/js:lint-code[lint-code]
  ...
  clients/api/python:build[build] --> helper/dummy-device/python:lint[lint]
  clients/soa/python:build[build] --> helper/dummy-device/python:lint[lint]
  clients/soa_services/electricalConnection/python:build[build] --> helper/dummy-device/python:lint[lint]
  services/common:build[build] --> integration-test:lint[lint]
  services/auth:build[build] --> integration-test:lint[lint]
  services/device:build[build] --> integration-test:lint[lint]
  services/experiment:build[build] --> integration-test:lint[lint]
  services/federation:build[build] --> integration-test:lint[lint]
  clients/api/js:build[build] --> integration-test:lint[lint]
  clients/soa/js:build[build] --> integration-test:lint[lint]
  clients/soa_services/electricalConnection/js:build[build] --> integration-test:lint[lint]
  helper/dummy-device/js:build[build] --> integration-test:lint[lint]
  helper/dummy-device/python:build[build] --> integration-test:lint[lint]
