...
| helper/dummy-device/js |   | [![build](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/js/dist/build.badge)](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/js/dist/build.log) |  |  | [![lint-code](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/js/dist/lint-code.badge)](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/js/dist/lint-code.log) |
| helper/dummy-device/python |   | [![build](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/python/dist/build.badge)](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/python/dist/build.log) | [![lint](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/python/dist/lint.badge)](https://ci.goldi-labs.de/crosslab/ci-cd/helper/dummy-device/python/dist/lint.log) |  |  |
